module.exports = (srv) => {
    ...
    srv.before(['UPDATE', 'UPSERT'], 'Extensions', req => { // must be synchronous to be handled first
        ...
        const tenant = _tenant(req) ?? req.data.tenant ?? req.tenant // TODO check if security is ensured

        // set tenant that was explicitly set in the request
        ...
        req.data.tenant = tenant  // could be kept in header data
    })
